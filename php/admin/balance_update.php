...
<body>
    ...
    <div class="cen2">
        ...
        ?>
        <form action="./balance_update2.php" method="POST">
            <div class="cen">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td2"><input type="text" name="account_number2"
                            ...
                            <td class="td3"><input type="text" name="balance2" value="<?php echo $row['balance']; ?>"
                                    style="padding: 5px; padding-left: 10px; display: flex; justify-content: center; align-items: center; outline: none; border: none; border-radius: 5px;" />
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="cen">
                <input type="submit" value="Update now" name="up2" id="up_btn">
            </div>
    </div>
    </form>
    <?php
