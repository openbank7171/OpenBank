...
?>
    <div class="h2">
        ...
        <h2>User Bonus Data....</h2>
        <ul class="ul1">
            <li class="li1"><a href="./user_signup.php">Home Page</a></li>
        </ul>
    </div>
    <div class="search">
        <form action="./in-s.php" method="post">
