...
<body>
    <div class="err"
        ...
        <img src="../img/cash_suc.gif" style="height: 200px; width: 200px;border-radius: 50%;">
        <br>
        <h2 style="color: green; text-shadow: 0px 0px 1px rgb(255, 255, 255);">Cash out successful.</h2>
