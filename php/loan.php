...
<body>
    ...
    <div class="loan">
        <img src="../img/clo.png" id="loancc" class="loancc"
            style="height: 40px; width: 40px; border-radius: 50%; margin-left: 92%; margin-top: 10px;  box-shadow: 0px 0px 10px white; cursor: pointer;">
        ...
        <div class="formloan">
            <div class="loanfoerm">
                <h3 style="text-align: center; text-decoration: 2px double underline green;">আপনার ব্যক্তিগত তথ্য দিন।
                </h3>

                <form action="./loan2.php" method="post" enctype="multipart/form-data">
                    <div class="lform">
                        <input type="text" name="loan_name" id="loan_name" class="allloan"
