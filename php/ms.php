                ...
                <tr>
                    <td>
                        <div class="msb2">
                            ...
                            <p id="ac">Transaction ID : <span id="tex2"> <?php echo $row3['transaction']; ?></span></p>
                ...
                <tr>
                    <td>
                        <div class="msb3">
                            ...
                            <p id="ac">Transaction ID : <span id="tex2"> <?php echo $row4['transaction']; ?></span></p>
                ...
                <tr>
                    <td>
                        <div class="msb2">
                            ...
                            <p id="ac">Transaction ID : <span id="tex2"> <?php echo $row5['transaction']; ?></span></p>
                ...
                <tr>
                    <td>
                        <div class="msb3">
                            ...
                            <p id="ac">Transaction ID : <span id="tex2"> <?php echo $row6['transaction']; ?></span></p>
                ...
                <tr>
                    <td>
                        <div class="msb2">
                            ...
                            <p id="ac" style="font-size: 12px;">Date Time : <span id="tex3" style="font-size: 12px;">
